...
class TestAdmin(unittest.TestCase):
    ...
    def test_find_user(self):
        ...
        os.remove(f'C:/Users/DearUser/Desktop/metro-gp/user/{user.id}.pickle')
    ...
    def test_save_user(self):
        ...
        with open(f'C:/Users/DearUser/Desktop/metro-gp/admin/{self.admin.id}.pickle', 'rb') as f:
    ...
    def test_ban_user(self):
        ...
        path = "C:/Users/DearUser/Desktop/metro-gp/user"
